...
//    EditText fullName, email;
    TextInputLayout displayName, email;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_test_add_details);
        ...
        saveBtn.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                if(!displayName.getEditText().getText().toString().isEmpty() && !email.getEditText().getText().toString().isEmpty())
                {
